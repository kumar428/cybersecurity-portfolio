...
Logged in as `msfadmin:msfadmin`, ran `ip a` → IP: `192.168.1.8`  
 Metasploitable terminal showing IP
...
Ping output   
![Ping Success](../assets/day04-ping-success.png.png)
...
Discovered 18 open ports, confirming full connectivity and service enumeration capability.  
 Nmap output   
![Nmap Scan](../assets/day04-nmap-fast-scan.png.png)
